...
nrow(gcount_filt_por2) #After
    #[1] 24301
```
We now have 22,214 genes remaining after filtering.  
...
#Build PERMANOVA model for all genes in the dataset.  
dim(test_por2)
#remember two of the values are for the right measurement are just names so actually = 22214)
...
Permutation: free
Number of permutations: 999
adonis2(formula = vegan_por2 ~ eatenvscontrol, data = test_por2, method = "eu")
               Df SumOfSqs     R2     F Pr(>F)
eatenvscontrol  1    19743 0.0808 0.879   0.57
Residual       10   224611 0.9192             
Total          11   244354 1.0000   

No difference in total gene expression - there may be individual DEGs.
