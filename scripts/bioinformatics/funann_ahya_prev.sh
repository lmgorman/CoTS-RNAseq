...
cp -r /work/pi_hputnam_uri_edu/refs/Ahyacinthus_genome/Ahyacinthus_genome_V1/Ahyacinthus.chrsV1.fasta $SCRATCHDIR
cp -r /work/pi_hputnam_uri_edu/refs/Ahyacinthus_genome/Ahyacinthus_genome_V1/Ahyacinthus.coding.gff3 $SCRATCHDIR
...
apptainer run "$FUNANNOTATE_SIF" funannotate annotate \
  --gff $SCRATCHDIR/Ahyacinthus.coding.gff3 \
  --fasta $SCRATCHDIR/Ahyacinthus.chrsV1.fasta \
  -s "Acropora hyacinthus" \
  -o $SCRATCHDIR/output \
