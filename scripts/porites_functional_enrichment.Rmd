...
```{r}
por_test_set<-por_eatenvscontrol_DEG_list%>%pull(GeneID) #this is our DEG genes
...
ggsave(
  "figures/porites/parent_enrich_plot4_por.svg",
  parent_enrich_plot4_por,
  width = 9,
  height = 5
)
```
...
ggsave(
  "figures/porites/parent_enrich_plot4_por_class.svg",
  parent_enrich_plot4_por_class,
  width = 9,
  height = 5
) 
```
