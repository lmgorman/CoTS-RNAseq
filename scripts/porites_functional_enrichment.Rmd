...
ggsave("figures/acropora/parent_enrich_plot1_por.pdf", plot = parent_enrich_plot1_por, width = 8, height = 15, units = "in")
...
ggsave(parent_enrich_plot3_por, filename="figures/acropora/por_parent_enrichment_individual_terms.png", width=10, height=11)
...
ggsave(parent_enrich_plot4_por, filename="figures/acropora/por_parent_enrichment_parent_terms.png", width=10, height=7)
```
