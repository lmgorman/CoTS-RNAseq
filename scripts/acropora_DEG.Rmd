...
dim(gcount)
```
Started with 27110 genes, ended with 25287 genes.  
...
Model     1    38615 0.14599 2.3932  0.002 ***
...
adonis2(formula = vegan_2 ~ eatenvscontrol, data = test_2, method = "eu")
         Df SumOfSqs      R2      F Pr(>F)   
Model     1    39100 0.15297 2.3477  0.001 **
...
```
We now have 1405 DEGS between eaten and control. 
